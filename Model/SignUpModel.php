...
class SignUpModel
{
    ...
    public $userInsert = "INSERT INTO `User` (firstName, lastName, email, password, userType, imagePath, addressID) VALUES (:firstName, :lastName, :email, :password, 1, 'default.jpg' ,:addressID)";
