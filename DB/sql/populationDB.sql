...
/* product*/
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (1, 'Nong Shim Gourmet Spicy Shin Ramen, Small', 22, 74, 'One of Korea''s most legendary instant ramen. If you are a connoisseur of ramen in all its forms, Nong Shim''s Hot & Spicy Shin Ramen is an absolute must-try. Possibly the singular most popular instant ramen in all of Korea, this ramen''s secret lies in the spicy soup broth, which is made with plenty of red chilli pepper as well as savoury garlic, onion, and anchovy. ',  true, 'Korea', 'Nong Shim', 'Nong-Shim-1.png', 1, 1);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (2, 'Sanyo Foods Pokemon Soy Sauce Ramen', 34, 83, 'For the Pokemon fan. Keep your strength up while walking around town catching Pokemon with this soy sauce flavoured instant ramen noodles. Coming with Pokemon''s iconic character Pikachu on every kamaboko fish cakes, this fun ramen noodles is the perfect snack to help you stay energised. Each packet comes with one of 20 different exclusive collectable Pokemon stickers. ',  false, 'Japan', 'Pokemon', 'Pokemon-1.png', 1, 1);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (3, 'Nong Shim Gourmet Spicy Shin Ramen Multipack', 69, 63, 'A classic and beloved Korean ramen. If you are a connoisseur of spicy instant ramen, Nong Shim''s Hot & Spicy Shin Ramen is an absolute must-try. This ramen''s secret lies in the spicy soup broth, which is made with plenty of red chilli pepper as well as savoury garlic, onion, and anchovy. Enjoy this ramen as it is for a lighter meal, or add your favourite meat and vegetable garnishes for something more substantial.', false, 'Korea', 'Nong Shim', 'Nong-Shim-2.png', 1, 1);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (4, 'Gekkeikan Daiginjo Sake with Ochoko Cup', 233, 58, 'Enjoy a taste of exquisite daiginjo sake with this sample bottle. Whether you''re trying daiginjo sake for the first time or finding a great sake for one, this sake by Gekkeikan, choice brewery of the Japanese Royal Family, is sure to please the palates of beginners and experts alike. Made from rice milled to 50% of its original size, this sake has a mild fruity flavour and gentle mouthfeel, with a small amount of brewer''s alcohol added to extract more lively aromas. The cap also doubles as an ochoko sake cup to drink from!',  false, 'Japan', 'Gekkeikan', 'Gekkeikan.png', 2, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (5, 'Asahi Dry Zero Alcohol-Free Beer Drink', 28, 148, 'Enjoy Japan''s bestselling beer refreshingly alcohol free. Retaining the crisp, light refreshment that made their versatile beer a go-to beverage for all drinking occasions, Asahi invites everyone to experience the exquisitely dry taste of this alcohol-free variant. Brewed with a satisfying dose of fibre and soy amino acids, this zero calorie beer keeps its wonderfully deep amber colour and depth, fizzing with a full, sweetened flavour that''s sure to provide a refreshing pick me up. Sugar free yet still wonderfully satisfying, this beer helps gives anyone access to Japan''s number one choice of relaxation. ',  false, 'Japan', 'Asahi', 'Asahi-1.png', 2, 1);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (6, 'Shinmei Toyama Koshihikari Rice, Small', 169, 80, 'A sweeter premium rice from Toyama. Try a slightly different flavour of rice with this 1kg bag of Koshihikari white rice. Grown in Nyuzen, an area of Toyama prefecture famous for its pure and fast flowing fresh spring waters, this Japonica rice has a unique flavour slightly sweeter than other Japanese rices, as well as the slightly sticky texture typical of Koshihikari rices. Use to make sushi or serve on the side of other Japanese dishes.',  false, 'Japan', 'Shinmei', 'Shinmei.png', 4, 1);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (7, 'Samyang Dukboki (tteokbokki)', 35, 60, 'A sweeter premium rice from Toyama. Try a slightly different flavour of rice with this 1kg bag of Koshihikari white rice.',  false, 'Korea', 'Shinmei', 'pinkNoodle.jpeg', 4, 1);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (8, 'Samyang Buldak', 169, 80, 'A sweeter premium noodle from Toyama. Try a slightly different flavour of rice with this 1kg bag of Koshihikari white rice.', false,  'Korea', 'Korea', 'samyang-carbo.jpg', 1, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (9, 'Jinro Soju Chamisul Grapefruit 13% 36 cl.', 48, 100, 'Also known as Korean vodka, it has a very smooth taste. It is a clear distilled spirit made from rice and the most popular type of alcoholic beverage in Korea.', false,  'Korea', 'Korea', 'soju-grape.jpeg', 2, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (10, 'Jinro Chamisul Soju Fresh 16,9% 35 cl.', 57, 200, 'Filtered four times through bamboo charcoal carefully selected from environmentally clean regions in Korea, Chamisul Fresh provides enhanced smoothness and a trendy design.',  false,  'Korea', 'Korea', 'soju-fresh.jpg', 2, 1);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (11, 'Kook Soon Dang Makgeolli Banan Rice Wine', 39, 100, 'Rice wine with delicious banan flavor. 4% alcohol. 750ml.',  false, 'Korea', 'Korea', 'ricewine.jpeg', 2, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (12, 'Lady Boba Taro Bubble Tea Drink 315 ml.', 19, 100, 'Taro is a purple root vegetable. If you have not tried it before, it tastes a bit like a potato with a nutty flavor, but deliciously, it is more sweet than spicy. It has all the classic Taro notes, and with hints of nuts and creamy vanilla, it is incredibly fuller and a personal favorite of mine. Highly recommended for anyone who wants to try a drink that is a little different.',  false, 'Korea', 'Korea', 'tea-drink.jpg', 3, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (13, 'Hatakosen ramune strawberry', 25, 100, 'Strawberry flavor soda. 200ml.',  false, 'Japan', 'Japan', 'jp-soda-strawb.png', 3, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (14, 'Hatakosen ramune blueberry', 25, 100, 'Blueberry flavor soda. 200ml.',  false, 'Japan', 'Japan', 'jp-soda-blueb.jpg', 3, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (15, 'Gyoza Duck Ajinomoto', 109, 100, 'Gyoza duck Ajinomoto 600 g.',  false, 'Korea', 'Ajinomoto', 'frozen-gyoza.jpeg', 5, 2);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (16, 'Sanquan', 29, 100, 'Peach Shaped Sweet Red Bean Paste Bun 12 stk.',  false, 'China', 'Sanquan', 'peach-buns.jpeg', 5, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (17, 'Gua Bao Buns Happy Belly', 55, 100, 'Gua Bao Buns Happy Belly (frozen) 400 g.',  false, 'China', 'HappyBelly', 'happy-belly.jpeg',  5, 1);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (18, 'Gyoza Pork Ajinomoto', 89, 200, 'Gyoza Pork Ajinomoto 600 g.',  false, 'Japan', 'Ajinomoto', 'gyoza-pork.jpeg', 5, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (19, 'Gyoza Pork & Vegetables Bibigo', 69, 100, 'Gyoza Pork & Vegetables Bibigo (frozen food) 600 g.',  false, 'South Korea', 'Bibigo', 'gyoza-dumplings.jpeg', 5, 2);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (20, 'Happy Belly Hargow Crystal Skin', 45, 200, 'Happy Belly Hargow Crystal Skin (frozen food) 300 g.',  false, 'China', 'HappyBelly', 'crystalSkin.jpeg',  5, 3);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (21, 'Synear Fried Sticks', 56, 200, 'Synear Fried Sticks (frozen) 450 g.',  false, 'China', 'Synear', 'fried-sticks.jpeg',  5, 2);
INSERT INTO Product (productID, title, price, stockQuantity, description,  isDailySpecial, country, brand, productImage, productTypeID, discountID) values (22, 'Jasmin Rice Royal Tiger', 129, 150, 'Royal Tiger jasmin rice premium quality 5 kg.',  false, 'Thailand', 'Royal Tiger', 'rice-golden-tiger.jpeg',  4, 3);
