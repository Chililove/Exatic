    ...
    ?>
            ...
            <div class="card" id="cardtop">
                <div class="embed-responsive embed-responsive-16by9">
                    ...
                    <a href="/Exatic/product-overview?"><img class="card-img-top-top" src="/Exatic/assets/<?php echo $row['productImage'] ?>" alt="Card image top" /></a>
                    <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="embed-responsive embed-responsive-16by9">
                                ...
                                <a href="/Exatic/product-overview?"><img class="card-img-top" src="/Exatic/assets/<?php echo $row['productImage'] ?>" alt="Card image top" /></a>
                                <div class="card-body">
                                    <h3 class="card-title"><?php echo $row["title"] ?>
                                        <?php if ($row['isNew']) {
