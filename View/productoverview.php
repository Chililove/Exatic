    ...
    <div class="container-fluid h-100">
        <div class="row d-flex justify-content-center h-100">
            <div class="container-fluid d-flex">
                <?php
                $overview = $_SERVER['QUERY_STRING'];  //move to model
                $product_details = "SELECT * FROM Product p, ProductType pt WHERE p.productTypeID = pt.productTypeID AND p.productID = $overview"; // move to model
                $overviewResult = $conn->query($product_details); //move to Controller
