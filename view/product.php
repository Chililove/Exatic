            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card" style="background: #c3dbb6">
                    <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                        ...
                        <img src="https://img.freepik.com/free-vector/banner-asian-food-restaurant-with-black-white-doodles_125540-1348.jpg"
                             class="w-100" />
                        <a href="#!">
                            <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100" style="background: #ccccff;">
                ...
                <div class="card" style="background: #c3dbb6">
                    <div class="bg-image ripple ripple-surface ripple-surface-light"
                        ...
                        <a href="#!">
                            <div class="mask">
                                <div class="d-flex justify-content-start align-items-end h-100" style="background: #ccccff;">
                                    <h5><span class="badge bg-danger ms-2">-20%</span>
                                </div>
                            </div>
                            <div class="hover-overlay">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
